...
`;
  ...
  static async send12pmAbsenceEmail(payload: EmailPayload): Promise<{ success: boolean; message: string }> {
    const user = (typeof process !== 'undefined' && process.env?.SMTP_USER) || 'kanzariyapratik124@gmail.com';
    const pass = (typeof process !== 'undefined' && process.env?.SMTP_PASS) || 'xrdtkwzkayzeerkf';
